...
namespace TeenPay.Controllers
{
   [Route("api/user")]
    ...
    public class UsersController : ControllerBase
    {
        ...
        public UsersController(NpgsqlDataSource ds) => _ds = ds;
        ...
        public async Task<IActionResult> GetPerson(int id, CancellationToken ct)
        {
            ...
            { 
                NpgsqlDbType = NpgsqlDbType.Json, Value = (object)(JsonSerializer.Serialize(Tid) ?? "{}") });

            cmd.Parameters.Add(new NpgsqlParameter 
            { 
                NpgsqlDbType = NpgsqlDbType.Json, Value = (object)("{}") });
